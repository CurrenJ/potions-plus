    ...
    public static Holder.@NotNull Reference<ConfiguredSkill<?, ?>> generate(BootstrapContext<ConfiguredSkill<?, ?>> context, HolderGetter<ConfiguredSkillPointSource<?, ?>> sourceLookup, List<Milestone> allOreHats, HolderGetter<ConfiguredGrantableReward<?, ?>> rewardLookup) {
        return context.register(ConfiguredSkills.MINING_CONFIGURED_KEY, new ConfiguredSkill<>(Skills.GENERIC.get(), new SkillConfiguration(
                ...
                ConfiguredSkills.createDefaultRewards(context)
                        ...
                        .addRewardForLevel(25, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.HOT_POTATO_INCREASE))
                        ...
                        .addRewardForLevel(42, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.HOT_POTATO_INCREASE))
                        ...
                        .addRewardForLevel(58, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.HOT_POTATO_INCREASE))
                        ...
                        .addRewardForLevel(75, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.HOT_POTATO_INCREASE))
