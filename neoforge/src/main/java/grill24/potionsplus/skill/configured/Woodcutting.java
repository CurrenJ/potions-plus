        ...
        return context.register(ConfiguredSkills.WOODCUTTING_CONFIGURED_KEY, new ConfiguredSkill<>(Skills.GENERIC.get(), new SkillConfiguration
                (Translations.TOOLTIP_POTIONSPLUS_SKILL_WOODCUTTING,
                        ...
                        ConfiguredSkills.createDefaultRewards(context)
                                .addRewardForLevel(5, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.AXE_EFFICIENCY_INCREASE))
                                .addRewardForLevel(15, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.AXE_EFFICIENCY_INCREASE))
                                .addRewardForLevel(24, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.AXE_EFFICIENCY_INCREASE))
                                .addRewardForLevel(32, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.AXE_EFFICIENCY_INCREASE))
                                .addRewardForLevel(48, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.AXE_EFFICIENCY_INCREASE))
                                .addRewardForLevel(56, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.AXE_EFFICIENCY_INCREASE))
                                .addRewardForLevel(71, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.AXE_EFFICIENCY_INCREASE))
                                .addRewardForLevel(84, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.AXE_EFFICIENCY_INCREASE))
                                .addRewardForLevel(93, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.AXE_EFFICIENCY_INCREASE))
                                .build(rewardLookup)
                )
        ));
    }
