...
public class CooldownAbilityInstanceData extends AdjustableStrengthAbilityInstanceData {
    ...
    public CooldownAbilityInstanceData(Holder<ConfiguredPlayerAbility<?, ?>> ability, boolean isEnabled, float abilityStrength, float maxAbilityStrength, long lastTriggeredTick) {
