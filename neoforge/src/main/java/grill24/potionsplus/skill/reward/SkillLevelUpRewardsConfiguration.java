...
public class SkillLevelUpRewardsConfiguration {
    ...
    public static class Builder {
        ...
        public SkillLevelUpRewardsConfiguration build(HolderGetter<ConfiguredGrantableReward<?, ?>> lookup) {
            Map<String, SkillLevelUpRewardsData> builtRewardsDataMap = new HashMap<>();
            rewardsDataMap.forEach((level, builder) -> builtRewardsDataMap.put(level, builder.build()));
