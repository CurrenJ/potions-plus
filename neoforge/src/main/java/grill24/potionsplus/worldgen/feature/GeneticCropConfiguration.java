...
public record GeneticCropConfiguration(BlockStateProvider toPlace, boolean scheduleTick, Genotype gLowerBound,
                                       Genotype gUpperBound) implements FeatureConfiguration {
