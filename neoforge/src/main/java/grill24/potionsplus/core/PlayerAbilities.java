...
public class PlayerAbilities {
    ...
    public static final DeferredHolder<PlayerAbility<?, ?>, PermanentAttributeModifiersAbility<Boolean, AttributeModifiersAbilityConfiguration>> PERMANENT_ATTRIBUTE_MODIFIERS = register("permanent_attribute_modifiers", () -> new PermanentAttributeModifiersAbility<>(AttributeModifiersAbilityConfiguration.CODEC));
