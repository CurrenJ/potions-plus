...
public class NeoSounds extends SoundDefinitionsProvider {
    ...
    static {
        ...
        Sounds.HERBALISTS_LECTERN_DISAPPEAR = HERBALISTS_LECTERN_DISAPPEAR;
        Sounds.PING_0 = PING_0;
        Sounds.PING_1 = PING_1;
        Sounds.PING_2 = PING_2;
        Sounds.PING_3 = PING_3;
        Sounds.GIANT_STEPS = GIANT_STEPS;
        Sounds.RECIPE_UNLOCKED = RECIPE_UNLOCKED;
        Sounds.MUTED_PLUCKS_0 = MUTED_PLUCKS_0;
        Sounds.MUTED_PLUCKS_1 = MUTED_PLUCKS_1;
        Sounds.SANGUINE_ALTAR_CONVERSION = SANGUINE_ALTAR_CONVERSION;
     ...
     */
    public NeoSounds(PackOutput output, String modId) {
        super(output, modId);
    }
