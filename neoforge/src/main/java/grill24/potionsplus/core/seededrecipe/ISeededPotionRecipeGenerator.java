...
public interface ISeededPotionRecipeGenerator {
    List<RecipeHolder<BrewingCauldronRecipe>> generateRecipes(PotionBuilder.PotionsAmpDurMatrix potionAmpDurMatrix, Set<PpIngredient> allRecipes, RandomSource random);
