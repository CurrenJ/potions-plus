...
public class FilterHopperUpgradeItems {
    ...
    public static void init(BiFunction<String, Supplier<Item>, Holder<Item>> register) {
                ...
                .recipeGenerator(holder -> new RecipeGeneratorUtility.RecipeGenerator<>(holder,
                        (recipeProvider, h) ->
                                recipeProvider.shaped(RecipeCategory.REDSTONE, h.value())
                                        ...
                                        .unlockedBy("has_quartz", recipeProvider.has(net.minecraft.world.item.Items.QUARTZ))))
        ).getHolder();
        ...
        FILTER_HOPPER_UPGRADE_ALLOW_FOOD = RegistrationUtility.register(register, SimpleItemBuilder.create("filter_hopper_upgrade_allow_food")
                ...
                .recipeGenerator(holder -> new RecipeGeneratorUtility.RecipeGenerator<>(holder,
                        (recipeProvider, h) ->
                                recipeProvider.shapeless(RecipeCategory.REDSTONE, FilterHopperUpgradeItems.FILTER_HOPPER_UPGRADE_ALLOW_FOOD.value())
                                        .requires(FilterHopperUpgradeItems.UPGRADE_BASE.value())
