...
public interface IGuiGraphicsMixin {
    ...
    void potions_plus$fill(RenderType renderType, float minX, float minY, float maxX, float maxY, int z, int color);
    void potions_plus$fill(float minX, float minY, float maxX, float maxY, int z, int color);
