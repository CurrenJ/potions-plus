...
/**
 * Dispatches the 7 event-coupled {@code effect/*} classes' now-plain static handler methods
 * (Phase 7) onto NeoForge's event bus. Mirrors 26.1.2's {@code event/neoforge/EffectListeners.java}.
 */
