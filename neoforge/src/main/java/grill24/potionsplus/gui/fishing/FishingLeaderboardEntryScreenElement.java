...
public class FishingLeaderboardEntryScreenElement extends HorizontalListScreenElement<RenderableScreenElement> {
    public FishingLeaderboardEntryScreenElement(Screen screen, ItemStack stack, Player player, Component text, Component textHeader) {
        super(screen, Settings.DEFAULT, YAlignment.CENTER, 2);

        this.setChildren(initializeElements(stack, player, text, textHeader));
    }

    public Collection<RenderableScreenElement> initializeElements(ItemStack stack, Player player, Component text, Component textHeader) {
        ...
        ItemStackScreenElement playerHead = new ItemStackScreenElement(this.screen, null, RenderableScreenElement.Settings.DEFAULT, Utility.getPlayerHead(player));
