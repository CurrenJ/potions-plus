package grill24.potionsplus.config.forge;
...
public class PotionsPlusConfig {
    ...
    static {
        Pair<PotionsPlusConfig, ForgeConfigSpec> pair = new ForgeConfigSpec.Builder().configure(PotionsPlusConfig::new);
        CONFIG = pair.getLeft();
    ...
    public PotionsPlusConfig(ForgeConfigSpec.Builder configBuilder) {
        potionDrinkTimeTicks = configBuilder.translation("configuration.potionsplus.potion_drink_time_ticks")
                .defineInRange("potionDrinkTimeTicks", 16, 0, Integer.MAX_VALUE);
        potionDrinkCooldownTimeTicks = configBuilder.translation("configuration.potionsplus.potion_use_cooldown_time_ticks")
