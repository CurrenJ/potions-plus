...
public class BrewingItems {
    ...
    public static void init(BiFunction<String, Supplier<Item>, Holder<Item>> register) {
        ...
        // registered (and bound). Forge defers item suppliers to the ITEM RegisterEvent, which
        // flushes after BLOCK, so FlowerBlocks.LUNAR_BERRY_BUSH is bound by the time this runs.
