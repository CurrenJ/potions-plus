...
public class Items {
    ...
    public static void init() {
        // No-op: forces class loading so the static initializer (above) runs and populates ITEMS.
    }
     ...
     * 1.21.1 Forge (the item model JSON comes from shared/common assets, Phase 10).
     */
     ...
     * generated on 1.21.1 Forge (the item model JSON comes from shared/common assets, Phase 10).
     */
