...
public class Sounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS = DeferredRegister.create(Registries.SOUND_EVENT, ModInfo.MOD_ID);
    ...
    private static Holder<SoundEvent> register(String name) {
        return ForgeHolder.of(SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(ppId(name))));
    }
