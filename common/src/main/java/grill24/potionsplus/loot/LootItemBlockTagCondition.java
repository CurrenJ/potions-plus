...
public record LootItemBlockTagCondition(TagKey<Block> block) implements LootItemCondition {
    public static final MapCodec<LootItemBlockTagCondition> MAP_CODEC = RecordCodecBuilder.<LootItemBlockTagCondition>mapCodec(
    ...
    @Override
    public MapCodec<LootItemBlockTagCondition> codec() {
        return MAP_CODEC;
    }
