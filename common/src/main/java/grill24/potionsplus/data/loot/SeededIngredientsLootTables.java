...
public class SeededIngredientsLootTables {
    private static final Logger LOGGER = LoggerFactory.getLogger(SeededIngredientsLootTables.class);
    ...
    public static Supplier<Map<PotionUpgradeIngredients.Rarity, Map<PpIngredient, Integer>>> POSSIBLE_INGREDIENTS = Suppliers.memoize(() -> generateAllPossibleIngredients(
    ...
    private static Map<PpIngredient, Integer> generateCommonIngredients() {
        ...
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, grill24.potionsplus.core.Tags.Items.SEEDS, blacklist));
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, grill24.potionsplus.core.Tags.Items.CROPS, blacklist));
        ...
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, grill24.potionsplus.core.Tags.Items.FOODS_RAW_MEAT, blacklist));
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, grill24.potionsplus.core.Tags.Items.FOODS_RAW_FISH, blacklist));
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, grill24.potionsplus.core.Tags.Items.FOODS_VEGETABLE, blacklist));
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, grill24.potionsplus.core.Tags.Items.FOODS_FRUIT, blacklist));
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, grill24.potionsplus.core.Tags.Items.MUSHROOMS, blacklist));
    ...
    private static Map<PpIngredient, Integer> generateRareIngredients() {
        ...
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, grill24.potionsplus.core.Tags.Items.FOODS_GOLDEN, blacklist));
    ...
    private static Optional<ItemStack> sample(LootTable table, RandomSource random) {
        ...
        if (items.isEmpty()) {
            if (Debug.DEBUG) {
                LOGGER.warn("Loot table returned no items: " + table);
            }
