...
public class SeededIngredientsLootTables {
    ...
    private static Map<PpIngredient, Integer> generateCommonIngredients() {
        ...
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, ConventionalTags.Items.SEEDS, blacklist));
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, ConventionalTags.Items.CROPS, blacklist));
        ...
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, ConventionalTags.Items.FOODS_RAW_MEAT, blacklist));
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, ConventionalTags.Items.FOODS_RAW_FISH, blacklist));
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, ConventionalTags.Items.FOODS_VEGETABLE, blacklist));
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, ConventionalTags.Items.FOODS_FRUIT, blacklist));
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, ConventionalTags.Items.MUSHROOMS, blacklist));
    ...
    private static Map<PpIngredient, Integer> generateRareIngredients() {
        ...
        map.putAll(generateLootWeightsFromTag(WeightingMode.DISTRIBUTED, 1, ConventionalTags.Items.FOODS_GOLDEN, blacklist));
