...
public class StunShotAbility extends CooldownTriggerableAbility<CriticalHitData, CustomPacketPayload> {
    ...
    @Override
    public Optional<CustomPacketPayload> onTriggeredFromServer(Player player, AbilityInstanceSerializable<?, ?> instance, CriticalHitData eventData) {
    ...
    @Override
    public Optional<CustomPacketPayload> onTriggeredFromClient(Player player, AbilityInstanceSerializable<?, ?> instance, CriticalHitData eventData) {
        return Optional.empty();
    }
