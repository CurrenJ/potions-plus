    ...
    public static Holder.@NotNull Reference<ConfiguredSkill<?, ?>> generate(BootstrapContext<ConfiguredSkill<?, ?>> context, HolderGetter<ConfiguredSkillPointSource<?, ?>> sourceLookup, HolderGetter<ConfiguredGrantableReward<?, ?>> rewardLookup) {
        return context.register(ConfiguredSkills.FARMING, new ConfiguredSkill<>(Skills.GENERIC.get(), new SkillConfiguration(
                ...
                ConfiguredSkills.createDefaultRewards(context)
                        ...
                        .addRewardForLevel(8, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.SIMPLE_DUNGEON_LOOT_EDIBLE[0].key()))
                        .addRewardForLevel(10, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.WHEAT_ADDITIONAL_SEEDS_LOOT.key()))
                        .addRewardForLevel(12, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.SMALL_HOE_EFFICIENCY_INCREASE))
                        .addRewardForLevel(15, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.BASIC_SKILL_LOOT_EDIBLE.key()))
                        .addRewardForLevel(16, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.NETHER_WART_BLAZE_POWDER_LOOT.key()))
                        .addRewardForLevel(18, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.SIMPLE_DUNGEON_LOOT_EDIBLE[1].key()))
                        ...
                        .addRewardForLevel(24, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.POTATO_POISONOUS_POTATO_LOOT.key()))
                        .addRewardForLevel(25, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.INTERMEDIATE_SKILL_LOOT_EDIBLE.key()))
                        .addRewardForLevel(28, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.BEETROOT_SUGAR_LOOT.key()))
                        ...
                        .addRewardForLevel(38, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.CARROT_GOLDEN_CARROT_LOOT.key()))
                        .addRewardForLevel(40, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.CHOOSE_LOOT_1.key()))
                        .addRewardForLevel(42, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.COCOA_COOKIE_LOOT.key()))
                        .addRewardForLevel(45, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.ADVANCED_SKILL_LOOT_EDIBLE.key()))
                        ...
                        .addRewardForLevel(65, builder -> builder.addReward(rewardLookup, ConfiguredGrantableRewards.EXPERT_SKILL_LOOT_EDIBLE.key()))
                        ...
                        .addRewardForLevel(100, builder -> builder
                                ...
                                .addReward(rewardLookup, ConfiguredGrantableRewards.MASTER_SKILL_LOOT_EDIBLE.key())
                        )
                        .build(rewardLookup)
        )));
    }
