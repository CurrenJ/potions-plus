...
public abstract class ShapelessProcessingRecipe implements Recipe<RecipeInput> {
    ...
    public ShapelessProcessingRecipe(RecipeCategory category, String group, List<PpIngredient> ingredients, ItemStack result, int processingTime, boolean canShowInJei) {
        this(category, group, ingredients, result, processingTime, canShowInJei, 1.0f);
    }

    public ShapelessProcessingRecipe(RecipeCategory category, String group, List<PpIngredient> ingredients, ItemStack result, int processingTime, boolean canShowInJei, float successChance) {
