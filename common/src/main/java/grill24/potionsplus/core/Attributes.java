...
/**
 * Loader-agnostic attribute hub. Holds the {@code Holder<Attribute>} statics for the 7 enchantment
 * bonus attributes plus the two percentage attributes (sprinting speed, use speed). The
 * {@code DeferredRegister} lives in the loader module (neoforge's {@code core.neoforge.PotionsPlus#ATTRIBUTES}),
 * which calls {@link #init} to register the enchantment bonuses and {@link #registerPlatformAttribute}
 * to register platform-specific attributes (NeoForge's {@code PercentageAttribute}, Fabric/Forge
 * fall back to vanilla {@link RangedAttribute}). See docs/multi-loader-expansion.md Phase 4.
 */
