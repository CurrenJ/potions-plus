...
public class ConfiguredGrantableRewards {
    ...
    public static final EdibleChoiceReward.ChoiceRewardBuilder[] SIMPLE_DUNGEON_LOOT_EDIBLE = register((i) -> new EdibleChoiceReward.ChoiceRewardBuilder("simple_dungeon_loot_edible_" + i,
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.MOSSASHIMI.getValue()), SIMPLE_DUNGEON_LOOT.getKey())
    ), 25);
    ...
    public static final EdibleChoiceReward.ChoiceRewardBuilder[] ABANDONED_MINESHAFT_LOOT_EDIBLE = register((i) -> new EdibleChoiceReward.ChoiceRewardBuilder("abandoned_mineshaft_loot_edible_" + i,
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.STONE_FRUIT.getValue()), ABANDONED_MINESHAFT_LOOT.getKey())
    ), 25);
    ...
    public static final EdibleChoiceReward.ChoiceRewardBuilder[] STRONGHOLD_LIBRARY_LOOT_EDIBLE = register((i) -> new EdibleChoiceReward.ChoiceRewardBuilder("stronghold_library_loot_edible_" + i,
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.CHOCOLATE_BOOK.getValue()), STRONGHOLD_LIBRARY_LOOT.getKey())
    ), 25);
    ...
    public static final EdibleChoiceReward.ChoiceRewardBuilder[] DESERT_PYRAMID_LOOT_EDIBLE = register((i) -> new EdibleChoiceReward.ChoiceRewardBuilder("desert_pyramid_loot_edible_" + i,
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.PYRAMIDS_OF_SALT.getValue()), DESERT_PYRAMID_LOOT.getKey())
    ), 25);
    ...
    public static final EdibleChoiceReward.ChoiceRewardBuilder[] JUNGLE_TEMPLE_LOOT_EDIBLE = register((i) -> new EdibleChoiceReward.ChoiceRewardBuilder("jungle_temple_loot_edible_" + i,
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.ROASTED_BAMBOO.getValue()), JUNGLE_TEMPLE_LOOT.getKey())
    ), 25);
    ...
    public static final EdibleChoiceReward.ChoiceRewardBuilder BASIC_SKILL_LOOT_EDIBLE = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("basic_skill_loot_edible",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.BASIC_LOOT.getValue()), BASIC_SKILL_REWARDS.getKey())
    ));
    ...
    public static final EdibleChoiceReward.ChoiceRewardBuilder INTERMEDIATE_SKILL_LOOT_EDIBLE = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("intermediate_skill_loot_edible",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.INTERMEDIATE_LOOT.getValue()), INTERMEDIATE_SKILL_REWARDS.getKey())
    ));
    ...
    public static final EdibleChoiceReward.ChoiceRewardBuilder ADVANCED_SKILL_LOOT_EDIBLE = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("advanced_skill_loot_edible",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.ADVANCED_LOOT.getValue()), ADVANCED_SKILL_REWARDS.getKey())
    ));
    ...
    public static final EdibleChoiceReward.ChoiceRewardBuilder EXPERT_SKILL_LOOT_EDIBLE = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("expert_skill_loot_edible",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.SPARKLING_SQUASH.getValue()), EXPERT_SKILL_REWARDS.getKey())
    ));
    ...
    public static final EdibleChoiceReward.ChoiceRewardBuilder MASTER_SKILL_LOOT_EDIBLE = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("master_skill_loot_edible",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.MASTER_LOOT.getValue()), MASTER_SKILL_REWARDS.getKey())
    ));
    ...
    public static final AbilityReward.AbilityRewardBuilder COCOA_COOKIE_LOOT = registerAbilityReward(ConfiguredPlayerAbilities.COCOA_ADDITIONAL_LOOT.getKey());
    ...
    public static EdibleChoiceReward.ChoiceRewardBuilder CHOOSE_LOOT_2 = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("choose_loot_2",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.SPARKLING_SQUASH.getValue()), STRONGHOLD_LIBRARY_LOOT.getKey()),
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.BLUEB_BERRIES.getValue()), DESERT_PYRAMID_LOOT.getKey())
    ));
    ...
    public static EdibleChoiceReward.ChoiceRewardBuilder CHOOSE_PICKAXE_EFFICIENCY_1 = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("choose_pickaxe_efficiency_1",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.SPARKLING_SQUASH.getValue()), SMALL_PICKAXE_EFFICIENCY_INCREASE.getKey()),
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.BLUEB_BERRIES.getValue()), SMALL_SUBMERGED_PICKAXE_EFFICIENCY_INCREASE.getKey())
    ));
    public static EdibleChoiceReward.ChoiceRewardBuilder CHOOSE_PICKAXE_EFFICIENCY_2 = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("choose_pickaxe_efficiency_2",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.FORTIFYING_FUDGE.getValue()), SMALL_PICKAXE_EFFICIENCY_INCREASE.getKey()),
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.BLUEB_BERRIES.getValue()), SMALL_SUBMERGED_PICKAXE_EFFICIENCY_INCREASE.getKey())
    ));
    ...
    public static EdibleChoiceReward.ChoiceRewardBuilder CHOOSE_PICKAXE_LOOT_1 = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("choose_pickaxe_loot_1",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.SPARKLING_SQUASH.getValue()), PICKAXE_DIAMOND_ORE_ADDITIONAL_EMERALDS_LOOT.getKey()),
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.BLUEB_BERRIES.getValue()), PICKAXE_DIAMOND_ORE_ADDITIONAL_LAPIS_LOOT.getKey())
    ));
    ...
    public static EdibleChoiceReward.ChoiceRewardBuilder EDIBLE_WHEEL_TREASURES = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("edible_wheel_treasures",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.WHEEL.getValue()), WHEEL_TREASURES.getKey())
    ));
    ...
    public static EdibleChoiceReward.ChoiceRewardBuilder EDIBLE_WHEEL_END_CITY = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("edible_wheel_end_city",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.WHEEL.getValue()), WHEEL_END_CITY.getKey())
    ));
    ...
    public static EdibleChoiceReward.ChoiceRewardBuilder EDIBLE_GEMS_AND_ORES_WHEEL = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("edible_gems_and_ores_wheel",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.WHEEL.getValue()), GEMS_AND_ORES_WHEEL.getKey())
    ));
    ...
    public static EdibleChoiceReward.ChoiceRewardBuilder EDIBLE_POTIONS_WHEEL = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("edible_potions_wheel",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.WHEEL.getValue()), POTIONS_WHEEL.getKey())
    ));
    ...
    public static EdibleChoiceReward.ChoiceRewardBuilder EDIBLE_UNKNOWN_POTION_INGREDIENT = register(() -> new EdibleChoiceReward.ChoiceRewardBuilder("edible_unknown_potion_ingredient",
            new Pair<ItemStack, ResourceKey<ConfiguredGrantableReward<?, ?>>>(new ItemStack(SkillLootItems.MOSSASHIMI.getValue()), UNKNOWN_POTION_INGREDIENT.getKey())
    ));
