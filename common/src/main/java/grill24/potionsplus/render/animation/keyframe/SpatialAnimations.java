...
public class SpatialAnimations {
    public static final Map<Identifier, SpatialAnimationData> CURVES = new HashMap<>();

    /**
     * Used in {@link grill24.potionsplus.render.animation.WheelItemActivationAnimation}
     */
    public static Identifier WHEEL_WINNER = register(ppId("wheel_winner"), new SpatialAnimationData()
            // Scale
    ...
    public static Identifier WHEEL_LOSERS = register(ppId("wheel_losers"), new SpatialAnimationData()
    ...
    public static Identifier WHEEL_SPIN = register(ppId("wheel_spin"), new SpatialAnimationData()
            .addKeyframe(SpatialAnimationData.Property.ROTATION, AnimationCurve.Keyframe.<Vector3f>builder().time(0).value(new Vector3f(0, 0, 0)).interp(Interpolation.Mode.EASE_IN_OUT_QUAD).build())
    ...
    public static Identifier WHEEL_POSITION_OFFSET = register(ppId("wheel_position_offset"), new SpatialAnimationData()
     ...
     */
    public static Identifier SKILL_ICON_HOVER = register(ppId("skill_icon_hover"), new SpatialAnimationData()
    ...
    public static Identifier SKILL_ICON_UNHOVER = register(ppId("skill_icon_unhover"), new SpatialAnimationData()
    ...
    public static Identifier SKILL_ICON_WHEEL_SELECTED = register(ppId("skill_icon_wheel_selected"), new SpatialAnimationData()
    ...
    public static Identifier SKILL_ICON_WHEEL_DESELECTED = register(ppId("skill_icon_wheel_deselected"), new SpatialAnimationData()
    ...
    public static Identifier SCALE_IN_BACK = register(ppId("scale_in_back"), new SpatialAnimationData()
    ...
    public static Identifier SCALE_OUT_QUAD = register(ppId("scale_out_back"), new SpatialAnimationData()
    ...
    public static Identifier BUTTON_WOBBLE = register(ppId("button_wobble"), new SpatialAnimationData()
    ...
    public static Identifier FISHING_REWARD_WIN_SPIN = register(ppId("fishing_reward_win_spin"), new SpatialAnimationData()
            .addKeyframe(SpatialAnimationData.Property.ROTATION, AnimationCurve.Keyframe.<Vector3f>builder().time(0).interp(Interpolation.Mode.EASE_IN_OUT_QUAD).value(new Vector3f(0, 0, 0)).build())
    ...
    public static Identifier register(Identifier id, SpatialAnimationData curve) {
        CURVES.put(id, curve);
        return id;
    }

    public static SpatialAnimationData get(Identifier id) {
        return CURVES.get(id);
    }

    public static SpatialAnimationData getOrDefault(Identifier id, SpatialAnimationData defaultCurve) {
        return CURVES.getOrDefault(id, defaultCurve);
    }

    public static SpatialAnimationData computeIfAbsent(Identifier id, SpatialAnimationData defaultCurve) {
