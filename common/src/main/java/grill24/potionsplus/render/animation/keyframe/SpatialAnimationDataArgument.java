...
public class SpatialAnimationDataArgument implements ArgumentType<SpatialAnimationDataArgument.Info> {
    public record Info(Identifier id, SpatialAnimationData spatialAnimationData) {
    }
    ...
    public Collection<String> getExamples() {
        return SpatialAnimations.getIds().stream().map(Identifier::toString).collect(Collectors.toList());
    }
