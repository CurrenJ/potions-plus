...
/**
 * No registry, no bootstrap - {@link FortuitousFateEffect#getEnchantmentBonus} is a pure function of
 * an amplifier, exactly the kind of behaviour {@code EffectScalingTest} argues does not need a game
 * test.
 */
class FortuitousFateEffectTest {

    private static final FortuitousFateEffect EFFECT = new FortuitousFateEffect(MobEffectCategory.BENEFICIAL, 0x43A047);
