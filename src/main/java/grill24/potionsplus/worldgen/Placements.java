...
public class Placements {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        final Holder<PlacedFeature> FISSURE = register(context, FISSURE_KEY, FISSURE_CONFIGURED, CountPlacement.of(75), InSquarePlacement.spread(), HeightRangePlacement.of(UniformHeight.of(VerticalAnchor.aboveBottom(12), VerticalAnchor.absolute(48))), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome());
    ...
    private static ResourceKey<PlacedFeature> createKey(String key) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(ModInfo.MOD_ID, key));
    }

    private static Holder<PlacedFeature> register(BootstapContext<PlacedFeature> context, ResourceKey<PlacedFeature> key, Holder<ConfiguredFeature<?, ?>> configuredFeature, PlacementModifier... modifiers) {
