...
py .\paste_image_atop.py output/copper_ore_b_%1 ore_edges/copper_ore_bottom.png output/%output%_copper_ore.png lighten %bottom_alpha%
...
py .\paste_image_atop.py output/diamond_ore_b_%1 ore_edges/diamond_ore_bottom.png output/%output%_diamond_ore.png lighten %bottom_alpha%
...
py .\paste_image_atop.py output/emerald_ore_b_%1 ore_edges/emerald_ore_bottom.png output/%output%_emerald_ore.png lighten %bottom_alpha%
...
py .\paste_image_atop.py output/gold_ore_b_%1 ore_edges/gold_ore_bottom.png output/%output%_gold_ore.png lighten %bottom_alpha%
...
py .\paste_image_atop.py output/lapis_ore_b_%1 ore_edges/lapis_ore_bottom.png output/%output%_lapis_ore.png lighten %bottom_alpha%
...
py .\paste_image_atop.py output/redstone_ore_b_%1 ore_edges/redstone_ore_bottom.png output/%output%_redstone_ore.png lighten %bottom_alpha%
...
py .\paste_image_atop.py output/iron_ore_b_%1 ore_edges/iron_ore_bottom.png output/%output%_iron_ore.png lighten %bottom_alpha%
...
py .\paste_image_atop.py output/coal_ore_b_%1 ore_edges/coal_ore_bottom.png output/%output%_coal_ore.png lighten %bottom_alpha%
